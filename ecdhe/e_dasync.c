...
int qat_ecdh_generate_key(EC_KEY *ecdh)
{
    ...
    int nid = 0;
    EC_KEY_METHOD *def_ec_meth = NULL;
    ...
    def_ec_meth = (EC_KEY_METHOD *)EC_KEY_get_default_method();
    ...
    pub_key = EC_KEY_get0_public_key((const EC_KEY *)eckey);
    EC_KEY_set_public_key(ecdh, pub_key);

    priv_key = EC_KEY_get0_private_key((const EC_KEY*)eckey);
    EC_KEY_set_private_key(ecdh, priv_key);
    EC_KEY_free(eckey);
